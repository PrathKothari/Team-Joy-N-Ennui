  ...
  return (
    <div className=" my-[3rem] flex flex-col border border-gray-300 py-5 px-4 rounded-lg shadow-lg bg-white ">
      ...
      <div className="border-t mt-4 h-[12rem]">
        ...
        >
          {[
            "/public/6-tomato-png-image.png",
            "/public/1-carrot-png-image.png",
            "/public/7-potato-png-images-pictures-download.png",
            "/public/8-onion-png-image.png",
            "/public/16-green-pepper-png-image.png",
          ].map((src, index) => (
            <div
              key={index}
